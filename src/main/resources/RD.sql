...
CREATE TABLE release_details (RD_ID INT NOT NULL ,release_type VARCHAR(5),ticket_number integer
,release_date DATE , release_desc VARCHAR(50),CONSTRAINT RDP_ID PRIMARY KEY (RD_ID));

create table partition(id INT NOT NULL ,description VARCHAR (30),CONSTRAINT PART_ID PRIMARY KEY (id));


CREATE TABLE deployment (DEP_ID INT NOT NULL ,composite_name VARCHAR(50),partition_Id INT NOT NULL,RDF_ID INT NOT NULL
...
CREATE TABLE JMS (JMS_Id  INT NOT NULL,RDF_ID INT NOT NULL, JMSType VARCHAR(3),JNDIName VARCHAR(50), JMSName VARCHAR(40),
...
CREATE TABLE data_source (DS_ID  INT NOT NULL,RDF_ID INT NOT NULL, DSName VARCHAR(50),DSJNDI VARCHAR(50), DBHost VARCHAR(40),
...
CREATE TABLE MDS (MDS_ID  INT NOT NULL,RDF_ID INT NOT NULL, serverLocation VARCHAR(150),target VARCHAR(100),
CONSTRAINT MDSP_Id  PRIMARY KEY (MDS_ID),
CONSTRAINT MDSRD_FID FOREIGN KEY (RDF_ID)REFERENCES release_details (RD_ID));

CREATE TABLE ftp_ADAPTER (FTPADP_ID  INT NOT NULL,RDF_ID INT NOT NULL, JNDI VARCHAR(30),CFI VARCHAR(50), CI VARCHAR(40),
...
CREATE TABLE CRONJOB(CronJob_ID  INT NOT NULL,RDF_ID INT NOT NULL, description VARCHAR(300),
